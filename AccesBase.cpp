...
AB::AccesBase::AccesBase(void)
{
    ...
    this->sCnx = "Data Source=DESKTOP-UT1JQET;Initial Catalog=Electronic;Persist Security Info=True;User ID=PROJET_POO_GROUPE_2;Password=***********;Encrypt=True;Trust Server Certificate=True";
