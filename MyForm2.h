...
namespace ProjetPOOGroupe2 {
	...
	public:
		...
		{
			InitializeComponent();
			this->button1->Click += gcnew System::EventHandler(this, &MyForm2::button1_Click); // Permet de lier le bouton � la fonction
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->radioButton1->Text = L"Creer un client";
			...
			this->radioButton2->Text = L"Modifier un client";
			...
			this->radioButton3->Text = L"Supprimer un client";
			...
			this->radioButton4->Text = L"Afficher un client";
