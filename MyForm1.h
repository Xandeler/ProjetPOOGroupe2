...
namespace ProjetPOOGroupe2 {
	...
	public:
		...
		{
			InitializeComponent();
			this->button1->Click += gcnew System::EventHandler(this, &MyForm1::button1_Click); // Permet de lier le bouton � la fonction
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->radioButton1->Text = L"Creer un personnel";
			...
			this->radioButton2->Text = L"Modifier un personnel";
			...
			this->radioButton3->Text = L"Supprimer un personnel";
			...
			this->radioButton4->Size = System::Drawing::Size(152, 20);
			this->radioButton4->TabIndex = 3;
			this->radioButton4->TabStop = true;
			this->radioButton4->Text = L"Afficher un personnel";
