...
{
	String^ requete;
	requete = this->Statistiques->Calcul_Panier_Moyen(id_commande);
...
{
	String^ requete;
	requete = this->Statistiques->Calcul_Chiffre_Affaires();
	return this->Acces_Base->getRows(requete, NomTable);
}
...
{
	String^ requete;
	requete = this->Statistiques->Produit_A_Commander();
	return this->Acces_Base->getRows(requete, NomTable);
}
...
{
	String^ requete;
	requete = this->Statistiques->Calcul_Montant_Client(id_client);
	return this->Acces_Base->getRows(requete, NomTable);
}
...
{
	String^ requete;
	requete = this->Statistiques->Articles_Plus_Vendus();
	return this->Acces_Base->getRows(requete, NomTable);
}
...
{
	String^ requete;
	requete = this->Statistiques->Articles_Moins_Vendus();
	return this->Acces_Base->getRows(requete, NomTable);
}
...
{
	String^ requete;
	requete = this->Statistiques->Calcul_Valeur_Commerciale_Stock();
	return this->Acces_Base->getRows(requete, NomTable);
}
...
{
	String^ requete;
	requete = this->Statistiques->Calcul_Valeur_Achat_Stock();
	return this->Acces_Base->getRows(requete, NomTable);
}
